...
const Home = () => {
  ...
  return (
    <Box>
          ...
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                >
                  Discover thousands of products for over 70 sports
                </Typography>
                <Typography
                  variant="body1"
                  sx={{
                ...
                >
                  From beginner to expert, find everything you need to practice your sport.
                  Quality equipment, expert advice, and unbeatable prices.
                </Typography>
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                >
                  ...
                  >
                    <EmojiEvents sx={{ fontSize: 60, color: '#FDD835', mb: 2 }} />
                    <Typography variant="h6" gutterBottom sx={{ fontWeight: 'bold', color: '#1a1a1a' }}>
                      Quality Guaranteed
                    </Typography>
                    <Typography variant="body2" sx={{ color: '#666' }}>
                      Premium sports equipment tested by professionals
                    </Typography>
                  </Paper>
                </Box>
              </motion.div>
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 6 }}>
          <Box>
            ...
            >
              Discover our most popular sports equipment
            </Typography>
          </Box>
          <Button
            component={Link}
      ...
      {/* App Download Section - Decathlon Style */}
        ...
        <Container maxWidth="lg">
          <Grid container spacing={6} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              >
                Shop on the go with our mobile app. Get exclusive deals, track your orders,
                and access your wishlist anywhere, anytime.
              </Typography>
            ...
            <Grid item xs={12} md={6}>
              ...
              >
                ...
                >
                  <GetApp sx={{ fontSize: 80, color: '#FDD835', mb: 2 }} />
